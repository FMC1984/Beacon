...
export default function RecommendationsPage() {
  ...
  return (
    <div className="space-y-6">
      <LegacyAnalysis propertyId={propertyId} only={["recommendations", "sources", "deferred"]} />
      <Panel title="Where to act" subtitle="Content gaps backed by cited competitor pages join these recommendations in a later slice.">
