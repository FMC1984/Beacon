    ...
    <div className="space-y-6">
      ...
      >
        <LoadState
          ...
          retry={retry}
          empty={{
            when: data !== null && data.total_citations === 0,
            title: "No cited sources yet",
            body: "Sources appear once monitored AI answers cite the web.",
          }}
        >
          {data && (
            <>
                ...
                <table className="w-full min-w-[560px] text-sm">
                  <thead className="text-left text-xs text-muted">
                    <tr className="border-b border-line">
                      ...
                      <th className="w-48 py-2 font-normal">
                        Share of citations
                      </th>
                    </tr>
                  </thead>
                    ...
                    {data.domains.map((d) => (
                      ...
                      >
                        ...
                        <td className="py-2 pr-3 text-xs text-muted">
                          {(d.source_type ?? "other").replace(/_/g, " ")}
                        </td>
      ...
      <TopCitationPagesPanel propertyId={propertyId} days={days} />
    </div>
  );
}
